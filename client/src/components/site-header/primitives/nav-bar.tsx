...
export function NavBar({
  ...
  return (
    <>
      <NavItem menu={menu} onClick={onClick} itemClassName={itemClassName} title={t("article.title")} selected={location.startsWith("/feeds") || location.startsWith("/feed")} href="/feeds" />
