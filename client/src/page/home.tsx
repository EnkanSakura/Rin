...
export function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="relative flex min-h-screen w-full max-w-3xl flex-col items-center">
        <div className="flex flex-1 flex-col items-center justify-center">
          ...
          <h1 className="mb-3 text-center text-4xl font-bold t-primary md:text-5xl">{siteConfig.name}</h1>
          {siteConfig.description && (
            <p className="mb-8 max-w-lg text-center text-base text-neutral-500 dark:text-neutral-400">
              {siteConfig.description}
            </p>
          )}
          {/* External Links — dynamically sized */}
        ...
        {/* Scroll-down hint — always at bottom, never overlaps */}
        <div className="mb-8 animate-bounce text-neutral-400">
      ...
      {siteConfig.aboutContent && (
        <section className="w-full max-w-3xl pb-16">
          ...
          <div className="rounded-2xl border border-black/10 px-6 py-8 dark:border-white/10">
